...
const faqs = [
  ...
  },
  {
    ...
    a: 'Você pode começar com um plano gratuito. Temos planos pagos com recursos avançados como histórico detalhado e alertas de risco.',
  },
  {
  ...
  return (
    <Box py={20} px={6} bg="white">
      ...
      <Box textAlign="center" mt={12}>
        <a
          href="https://wa.me/5599999999999?text=Olá! Preciso de ajuda com o Investiga+"
          target="_blank"
